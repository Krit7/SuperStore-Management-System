...
/**
 * Store admin5_2 controller class
 * 
 * @author Jatin
 *
 */
public class Store_Admin_5_2_Controller implements Initializable {
	public Category c;
	...
	private void load() {
		c = SuperUser.Stores.get(Integer.parseInt(primaryStage.getTitle().split(" ")[1])).getAdmin().c[2];
